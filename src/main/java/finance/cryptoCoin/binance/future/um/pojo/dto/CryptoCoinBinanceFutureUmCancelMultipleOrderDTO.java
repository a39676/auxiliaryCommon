...
public class CryptoCoinBinanceFutureUmCancelMultipleOrderDTO extends CryptoCoinInteractionSingleUserCommonDTO {
	...
	public String toString() {
		return "CryptoCoinBinanceFutureUmCancelMultipleOrderDTO [symbol=" + symbol + ", orderSideCode=" + orderSideCode
				+ ", positionSideCode=" + positionSideCode + ", orderTypeCode=" + orderTypeCode
				+ ", cancelIfOrderPriceHigherThan=" + cancelIfOrderPriceHigherThan + ", cancelIfOrderPriceLowerThan="
				+ cancelIfOrderPriceLowerThan + ", cancelAllOpenOrder=" + cancelAllOpenOrder + ", userId=" + userId
