...
public class CryptoCoinMQConstant {
	...
	public static final String BIG_MOVE_SPOT_DATA = "CryptoCoinBigMoveSpotData";
	public static final String BIG_TRADE_FUTURE_UM_DATA = "CryptoCoinBigTradeFutureUmData";
